<?php 
    ...
    if (empty($id)) {
        echo '<script>alert("Data tidak valid!"); window.location.href="../kelas_matakuliah";</script>';
        exit;
    }
    ...
    if ($data_kelas) {
        ...
        if ($hapus_detail) {
         ...
         echo '<script>alert("Data tidak ditemukan di kelas manapun!"); window.location.href="../kelas_matakuliah";</script>';
    }
?>