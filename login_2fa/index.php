...
<div class="login-box">
  <div class="login-logo">
    <a href="../asset_web/index2.html">2 FACTOR AUTHENFICATION</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
      ...
      if (isset($_POST['submit'])) {
         ...
         if ($pin_inputan_pengguna == $pin) {
            if ($peran == 'M') {
                echo '
                <script>
                window.location = "../home_mahasiswa/";
                </script>
                ';
            } elseif ($peran == 'D') {
                echo '
                <script>
                window.location = "../home_dosen/";
                </script>
                ';
            } else {
                echo '
            ...
            echo '
            <script>
            alert("PIN ANDA SALAH!!! SILAHKAN LOGIN LAGI");
