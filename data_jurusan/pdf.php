...
$pdf->Cell(45, 7, 'Kode Matkul', 1, 0, 'C');
$pdf->Cell(80, 7, 'Nama Matkul', 1, 0, 'C');
$pdf->Cell(25, 7, 'SKS', 1, 0, 'C');
$pdf->Cell(25, 7, 'CPMK', 1, 1, 'C');
...
if ($rv > 0) {
    ...
    while ($data = mysqli_fetch_array($query_ambil_matkul)) {
        $pdf->Cell(12, 7, $no++, 1, 0, 'C');
        $pdf->Cell(45, 7, $data['kode_matkul'], 1, 0, 'C');
        $pdf->Cell(80, 7, $data['nama_matkul'], 1, 0, 'L');
        $pdf->Cell(25, 7, $data['jml_sks'], 1, 0, 'C');
        $pdf->Cell(25, 7, $data['jml_cpmk'], 1, 1, 'C');
    }
}
$pdf->Output();
?>
