...
<head>
  ...
  <?php 
   include '../css.php';
   // Diubah agar menu sidebar aktif di 'Kelas Matakuliah'
   $hal = 'admin_kelas_matkul'; 
  ?>
</head>
        ...
        <form action="" method="post">
          <div class="row">
            ...
            <div class="col-6">
              ...
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-default" ><i class="fas fa-plus" ></i> Tambah Data</button>
              <a href="excel.php" type="button" target="_blank" class="btn bg-pink">
                  <i class="fas fa-file-excel"></i> Export Data Excel</a>
              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-impor" ><i class="fas fa-file-excel" ></i> Impor Data</button>
            </div>
          </div>
        </form>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $panggil_data_kelas = mysqli_query($con, "SELECT * FROM tbl_kelas_matkul WHERE kode_akd = '$filter'") or die(mysqli_error($con));
                    ...
                    if ($rv > 0) {
                      while ($data = mysqli_fetch_array($panggil_data_kelas)) {
                        ...
                        <tr>
                          ...
                          <a href='../detail_kelas_matkul/index.php?user=<?= $kode_kelas?>' class="btn btn-danger btn-xs">
