                    ...
                    <div class="card-body">
                        ...
                        if(!$data){
                            echo '<script>
                                ...
                                window.location.href="../kelas_matkul_dosen";
                                exit;
                            </script>';
                        }
                    ...
                    if ($rv > 0) {
                      while ($data = mysqli_fetch_array($panggil_data_kelas)) {
                        ...
                        <tr>
                          ...
                          <td>
                            <a href='hapus.php?user=<?= $data['id'];?>' class="btn btn-danger btn-xs" onclick="return confirm('yakeeeen?')">
                ...
                <select class="form-control" name="kode_kelas">
                  ...
                  if ($panggil_kelas && mysqli_num_rows($panggil_kelas) > 0) {
                      while ($data_periode = mysqli_fetch_array($panggil_kelas)) {
                          $kode_kls = $data_periode['kode_kelas'];
                          $nama_kls = $data_periode['nama_kelas'];
                      ?>
                        <option value="<?= $kode_kls; ?>"><?= $kode_kls ?> - <?= $nama_kls ?></option>
                      <?php 
                      }
                  }
                  ?>
