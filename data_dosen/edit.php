       ...
       <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="nik_disable" class="form-control" id="nik" value="<?= $nik; ?>" placeholder="Masukan NIK" disabled>
                  <input type="number" name="nik" class="form-control" id="nik" value="<?= $nik; ?>" placeholder="Masukan NIK" hidden>
                </div>

                <div class="form-group">
                  <label for="name">Nama Dosen</label>
                  <input type="text" name="name" class="form-control" id="name" value="<?= $nama; ?>" placeholder="Masukan Nama Dosen" required>
                </div>
