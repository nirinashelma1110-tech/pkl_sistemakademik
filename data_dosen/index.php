          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $rv = mysqli_num_rows($panggil_data_dosen); //tampung nilai kembali
                    ...
                    <tr>
                      ...
                      <td>
                            ...
                            if ($jenis_kelamin == 'L') {
                              ...
                              data-nik="<?= $nik; ?>"> 
                              <src="../asset_web/image/dosen_lakilaki.jpeg" alt="dosen" class="image-fluid"</button>
                              <img src="<?= (!empty($image)) ?$image : '../asset_web/image/dosen_lakilaki.jpeg' ?>" alt="dosen" class="img-fluid" style="width: 100px ;"> 
                              <?php
                            } else {
                              ?>
                              <button type="button" class="btn btn-default mb-2" 
                              data-toggle="modal" data-target="#modal-foto" 
                              data-nik="<?= $nik; ?>"> 
                              <src="../asset_web/image/dosen.png" alt="dosen" class="img-fluid"
                              </button>
                              <img  src="<?= (!empty($image)) ?$image : '../asset_web/image/dosen.png' ?>" alt="dosen" class="img-fluid" style="width: 100px ;"> 
                              <?php
                            }
                            ?>
                      ...
                      <td>
                        <a href='hapus.php?user=<?= $data['nik'];?>' class="btn btn-danger btn-xs" onclick="return confirm('yakeeeen?')">
                          <i class="fas fa-trash"></i>
                        </a>

                        <a href='edit.php?user=<?= $data['nik'];?>' class="btn btn-success btn-xs">
                        ...
                        <a href='profile.php?user=<?= $data['nik'];?>' class="btn btn-warning btn-xs">
        ...
        <form action="tambah_dosen.php" method="post">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="file" name="image" class="form-control" id="image" placeholder="Upload Foto" required>
            </div>
      ...
      <form action="impor.php" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
           ...
           <a href="template/template_data_dosen.xls" class="btn btn-success" download>Download</a>
          </div>
