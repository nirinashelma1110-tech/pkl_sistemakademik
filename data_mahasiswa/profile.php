  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
     <?php
        ...
        $query_ambil_data = mysqli_query($con, "SELECT * FROM tbl_mahasiswa WHERE nim = '$mahasiswa'");
                    ...
                    <div class="card-body">
                        <div class="mb-3 text-center">
                             <?php
                                  if($kelamin == 'L'){
                                    ?>
                                    <img src="<?= (!empty($image))?$image : '../asset_web/image/mhs_lakilaki.png'?>" alt="mahasiswa" class="img-fluid" style="width: 280px ;">
                                    <?php
                                  } else {
                                    ?>
                                    <img src="<?= (!empty($image))?$image : '../asset_web/image/mhs_perempuan.png'?>" alt="mahasiswa" class="img-fluid" style="width: 280px ;">
                                    <?php
                                  }
                                  ?>
                        </div>
                        <button type="button" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#modal-ubah-foto" data-nim="<?= $nim; ?>">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                         ...
                         <a href="../data_mahasiswa/" class="btn btn-primary" ">
